...
async function generateAds() {
    ...
    تاريخ الإعلانات السابقة (حاول أن تكون مبدعاً ومختلفاً عنها):
    ${history.join('\n')}

    المطلوب:
    1. عدد 8 إعلانات قصيرة (تغريدات) لمنصة X.
    2. عدد 4 إعلانات جذابة لمنصة Instagram.
    
    الشروط:
    - استخدم لهجة سعودية بيضاء جذابة ومشوقة.
    - ركز على الفوائد (زيادة المبيعات، الوصول للعملاء، السهولة).
    - أضف إيموجي وهاشتاقات مناسبة.
